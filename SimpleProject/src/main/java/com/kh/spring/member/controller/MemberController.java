...
public class MemberController {
	...
	*/
	...
	public String delete(MemberDTO member,HttpSession sesison) {
		
		log.info(((MemberDTO)sesison.getAttribute("loginMember")).getMemberPw());
		member.setMemberId(((MemberDTO)sesison.getAttribute("loginMember")).getMemberId());
