...
public class SafetyService {
	...
	public String requestHospitalApi() throws IOException {
		 ...
		 * API서버로 요청 보내고 응답 받아서 콘솔에 출력하가ㅣ
		 */
		
		StringBuilder sb = new StringBuilder();
		sb.append("https://www.safetydata.go.kr/V2/api/DSSP-IF-10840");
		sb.append("?serviceKey=3Z154R0542406O2O");
        ...
        // API 서버와 스트림 연결 (보조 스트림인 Buffered Reader)
	...
	public String requestMessage(int pageNo) {
		...
		final String SERVICE_KEY = "5252R736U808SNSH";
	...
	public String getItems(String query) {
        String clientId = "nqO4pM3CfKoq0MsGFZDw"; //애플리케이션 클라이언트 아이디
        String clientSecret = "xRAHtzMc50"; //애플리케이션 클라이언트 시크릿
